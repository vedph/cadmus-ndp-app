...
3. `docker build . -t vedph2020/cadmus-ndp-app:2.0.0 -t vedph2020/cadmus-ndp-app:latest` (replace with the current version).

Remember to push the image with docker push twice (for version number and `latest`).
